...
def translateTag_to_sc(tag):
    ...
    if tranlate_to_sc:
        dict_gen = {'中文字幕': '中文字幕', '推薦作品': '推荐作品', '通姦': '通奸', '淋浴': '淋浴', '舌頭': '舌头',
                    ...
                    '新人': '新人', '推銷': '推销', 'ブルマ': '运动短裤', '润滑剂': '乳液',

                    'AV女優': 'AV女优', '情人': '情人', '丈夫': '丈夫', '辣妹': '辣妹', 'S級女優': 'S级女优', '白領': '职员',
                    ...
                    '迷你裙': '迷你裙', '套裝': '套装', '眼鏡': '眼镜', '丁字褲': '丁字裤', '陽具腰帶': '阴茎腰带', '男装': '男装',
                    '襪': '袜',
                    ...
                    '吞精': '吞精', '鴨嘴': '鸭嘴', '打飛機': '打飞机', '剃毛': '剃毛', '站立位': '站立位', '高潮': '极致・性高潮',
                    ...
                    '假陽具': '假阴茎', '變態遊戲': '变态游戏', '注視': '注视', '蠟燭': '蜡烛', '電鑽': '电钻', '亂搞': '乱搞',
                    ...
                    '更衣室': '更衣室', '下午': '下午', 'KTV': 'KTV', '白天': '白天', '最佳合集': '精选・综合', 'VR': 'VR',
                    '動漫': '动漫', 'HDTV': '',
                    ...
                    'DMM獨家': 'DMM独家', '單體作品': '单体作品', '合集': '精选・综合', '高清': '高清', '字幕': '字幕', '天堂TV': '天堂TV',
                    ...
                    'ディルド': '假阴茎', 'ヨガ': '瑜伽', '飲み会・合コン': '酒会・联谊会', '部活・マネージャー': '社团・经理', 'お婆ちゃん': '外婆',
